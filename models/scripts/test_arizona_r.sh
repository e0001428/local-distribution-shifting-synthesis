...
verbose=True
batch=1
result_dir=result/regression/$dataset
...
criterias='randomflip randomflipNN'
trigger='random'
lb_strategy='major'
holes='10.185'
restore='F'
